...
const getCreateSelectorFunction = () => (0, _reselect.createSelector)(data => data.metrics, data => data.percentMetrics, data => data.records, (metrics, percentMetrics, records) => processMetrics(metrics, percentMetrics, records));
